...
![IO node attribute visual](https://cdn.junglesequencer.com/v1.0.x/documentation/jungle-nodes/io-node-attribute-visual.png)
...
![IO node example visual](https://cdn.junglesequencer.com/v1.0.x/documentation/jungle-nodes/io-node-example.png)
