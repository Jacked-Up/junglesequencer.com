...
![Branch node attribute visual](https://cdn.junglesequencer.com/v1-0-5/documentation/jungle-nodes/branch-node-attribute-visual.png)
...
![Branch node example visual](https://cdn.junglesequencer.com/v1-0-5/documentation/jungle-nodes/branch-node-example.png)
