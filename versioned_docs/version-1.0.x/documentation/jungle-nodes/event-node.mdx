...
![Event node attribute visual](https://cdn.junglesequencer.com/v1-0-5/documentation/jungle-nodes/event-node-attribute-visual.png)
...
![Timed intervals node visual](https://cdn.junglesequencer.com/v1-0-5/documentation/jungle-nodes/event-node-example.png)
