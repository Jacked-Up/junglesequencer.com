...
![WaitForTimeNode Details Box](https://cdn.junglesequencer.com/v1-0-5/guides/waitfortimenode-details-box-example.png)
...
![WaitForTimeNode Progress Bar](https://cdn.junglesequencer.com/v1-0-5/guides/waitfortimenode-progress-bar-example.gif)
