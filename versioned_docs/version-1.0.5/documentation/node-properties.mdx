...
![Node title property highlighted](https://cdn.junglesequencer.com/v1-0-5/documentation/node-properties-title.png)
...
![Node description property highlighted](https://cdn.junglesequencer.com/v1-0-5/documentation/node-properties-description.png)
...
![Node color property highlighted](https://cdn.junglesequencer.com/v1-0-5/documentation/node-properties-color.png)
