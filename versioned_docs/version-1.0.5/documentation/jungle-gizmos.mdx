...
![Arrow pointing to where to enable gizmos in game view](https://cdn.junglesequencer.com/v1-0-5/documentation/jungle-enable-gizmos-in-game-view.jpg)
:::
...
![Arrows pointing to gizmos draw by the nodes](https://cdn.junglesequencer.com/v1-0-5/documentation/jungle-gizmos-example.jpg)
