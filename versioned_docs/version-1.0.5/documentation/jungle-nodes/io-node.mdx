...
It takes a single input of any type, and outputs to a single outputof any type.
...
![IO node attribute visual](https://cdn.junglesequencer.com/v1-0-5/documentation/jungle-nodes/io-node-attribute-visual.png)
...
![IO node example visual](https://cdn.junglesequencer.com/v1-0-5/documentation/jungle-nodes/io-node-example.png)
