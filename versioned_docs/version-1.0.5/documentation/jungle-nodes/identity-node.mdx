...
![Identity node attribute visual](https://cdn.junglesequencer.com/v1-0-5/documentation/jungle-nodes/identity-node-attribute-visual.png)
...
![Identity node input type example](https://cdn.junglesequencer.com/v1-0-5/documentation/jungle-nodes/identity-node-input-type-example.gif)
...
![Identity node example](https://cdn.junglesequencer.com/v1-0-5/documentation/jungle-nodes/identity-node-example.png)
