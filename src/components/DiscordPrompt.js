    ...
    return (
        <div className={`discord-prompt ${hide ? 'hide' : ''}`}>
            <div className="content">
                <p><strong>Need help with Jungle?</strong> Join our Discord for tips, updates, and community support.</p>
                <div className="discord-buttons">
                    <a href="https://discord.gg/vJ4AXsExfE" target="_blank" rel="noopener noreferrer" className="discord-button" onClick={handleJoin}>
                        <img
