...
Jungle provides a way to revert actions by defining a revert method on your nodes. These methods can then be registered
with the tree and will be called when the tree stops or is finished running.
