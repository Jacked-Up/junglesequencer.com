...
slug: /guides/node-features/custom-inspector
---

Creating custom node inspectors is a great way to add custom functionality to your nodes.
Custom node inspectors work exactly like building custom inspectors for Unity MonoBehaviours.
...
![Custom inspector applied vs not](https://cdn.junglesequencer.com/v1-1-0/guides/node-features/custom-inspector-good-vs-bad.png)
