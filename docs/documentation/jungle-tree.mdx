...
Trees act as the containers for your nodes.
Each tree should represent a sequence of actions that you want to execute in your game.
...
This will create a new tree asset in your project. Double-clicking the tree will open it in the editor.
...
<VideoPlayer
    videoUrl="https://youtu.be/OsJylOYYcfk"
    title="Starting Jungle Trees"
    description="Here's a video that goes over starting Jungle Trees via the Jungle Player and via script."
/>

<br />
Trees can be referenced as serialized fields in your scripts.
...
<br />_List of all nodes associated with this tree._

<span class="DocItemTitle">State</span>
<br />`public StateFlag State { get; }`
<br />_The current state of the tree._
...
<br />_Invoked when a node is started in the tree._

<span class="DocItemTitle">OnNodeStopped</span>
<br />`public event Action<JungleNode> OnNodeStopped`
<br />_Invoked when a node is stopped in the tree._
...
<br />_Starts running the tree._

<span class="DocItemTitle">Stop()</span>
<br />`public void Stop()`
<br />_Stops running the tree._
...
<br />_Adds a Jungle Node to the tree._
...
<br />_Adds multiple Jungle Nodes to the tree._
...
<br />_Removes a node from the tree._
...
<br />_Removes these nodes from the tree._
