...
The `JungleTree` class is a container for storing and managing sequences of `JungleNode`s. It includes helper methods for adding, removing, connecting, and disconnecting `JungleNode`s.
