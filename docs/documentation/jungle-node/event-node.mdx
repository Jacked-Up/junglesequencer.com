...
![Event node attribute visual](https://cdn.junglesequencer.com/v1-1-0/documentation/jungle-node/event-node-attribute-visual.png)
...
![Timed intervals node visual](https://cdn.junglesequencer.com/v1-1-0/documentation/jungle-node/event-node-example.png)
