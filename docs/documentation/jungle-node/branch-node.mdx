...
![Branch node attribute visual](https://cdn.junglesequencer.com/v1-1-0/documentation/jungle-node/branch-node-attribute-visual.png)
...
![Branch node example visual](https://cdn.junglesequencer.com/v1-1-0/documentation/jungle-node/branch-node-example.png)
