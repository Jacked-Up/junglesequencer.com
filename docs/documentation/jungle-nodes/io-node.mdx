...
<span class="DocItemTitle">OnStart(<span class="DocItemParameter">T</span>)</span>
<br />`protected abstract void OnStart(in T inputValue)`
<br />_Called immediately when the node is called by another node. The input value is the value sent by the calling node._
